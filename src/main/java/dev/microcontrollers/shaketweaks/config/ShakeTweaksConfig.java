...
public class ShakeTweaksConfig {
    ...
    public static Screen configScreen(Screen parent) {
        return YetAnotherConfigLib.create(CONFIG, ((defaults, config, builder) -> builder
                .title(Text.translatable("key.shake-tweaks.shake-tweaks"))
                .category(ConfigCategory.createBuilder()
                        .name(Text.translatable("key.shake-tweaks.shake-tweaks"))
                        .option(Option.createBuilder(boolean.class)
                                .name(Text.translatable("key.shake-tweaks.disable-screen-bobbing"))
                                .description(OptionDescription.of(Text.translatable("key.shake-tweaks.disable-screen-bobbing.description")))
                                .binding(defaults.disableScreenBobbing, () -> config.disableScreenBobbing, newVal -> config.disableScreenBobbing = newVal)
                                .controller(TickBoxControllerBuilder::create)
                                .build())
                        .option(Option.createBuilder(boolean.class)
                                .name(Text.translatable("key.shake-tweaks.disable-hand-bobbing"))
                                .description(OptionDescription.of(Text.translatable("key.shake-tweaks.disable-hand-bobbing.description")))
                                .binding(defaults.disableHandBobbing, () -> config.disableHandBobbing, newVal -> config.disableHandBobbing = newVal)
                                .controller(TickBoxControllerBuilder::create)
                                .build())
                        .option(Option.createBuilder(boolean.class)
                                .name(Text.translatable("key.shake-tweaks.disable-map-bobbing"))
                                .description(OptionDescription.of(Text.translatable("key.shake-tweaks.disable-map-bobbing.description")))
                                .binding(defaults.disableMapBobbing, () -> config.disableMapBobbing, newVal -> config.disableMapBobbing = newVal)
                                .controller(TickBoxControllerBuilder::create)
                                .build())
                        .option(Option.createBuilder(boolean.class)
                                .name(Text.translatable("key.shake-tweaks.disable-screen-damage-tilt"))
                                .description(OptionDescription.of(Text.translatable("key.shake-tweaks.disable-screen-damage-tilt.description")))
                                .binding(defaults.disableScreenDamage, () -> config.disableScreenDamage, newVal -> config.disableScreenDamage = newVal)
                                .controller(TickBoxControllerBuilder::create)
                                .build())
                        .option(Option.createBuilder(boolean.class)
                                .name(Text.translatable("key.shake-tweaks.disable-hand-damage-tilt"))
                                .description(OptionDescription.of(Text.translatable("key.shake-tweaks.disable-hand-damage-tilt.description")))
